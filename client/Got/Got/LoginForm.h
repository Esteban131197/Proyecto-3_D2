...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// CommitBoton
			// 
			this->CommitBoton->Location = System::Drawing::Point(168, 172);
			...
			this->ClientSize = System::Drawing::Size(377, 244);
...
#pragma endregion
	...
	private: System::Void CommitBoton_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (isValid) {
			...
			String^ cmdString = "INSERT INTO usuarios (id,name,repositorio,commitdescripcion) VALUES (@Id,@Nombre,@NombreRepo,@DescripCommit)";
